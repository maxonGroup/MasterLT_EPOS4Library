...
typedef enum EPOS_OD {
    ...
    EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_ERROR_CONTROL = 0x4012EC0,
     EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_CAN_NMT_STATE = 0x4022EC0,
     EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_BOOTLOADER_REVISION_NUMBER = 0x4032EC0,
     EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_BOOTLOADER_PRODUCT_CODE = 0x4042EC0,
     EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_EXTENSION_COMMUNICATION_ERROR_CODE = 0x2052EC0,
     EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_ESM_STATE = 0x2062EC0,
     EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_LED_IDENTIFICATION = 0x1082EC0,
     EPOS_OD_INTERNAL_DEVICE_CONTROL_INTERNAL_DEBUG_STATE = 0x2092EC0,
     ...
     EPOS_OD_VELOCITY_CONTROL_PARAMETER_SET_VELOCITY_CONTROLLER_FILTER_CUT_OFF_FREQUENCY = 0x20530A2,
    ...
    EPOS_OD_CURRENT_THRESHOLD_FOR_HOMING_MODE = 0x20030B2,
     EPOS_OD_INTERNAL_HOMING_DATA_INTERNAL_ABSOLUTE_HOME_REFERENCE = 0x40130B5,
     EPOS_OD_INTERNAL_HOMING_DATA_INTERNAL_ABSOLUTE_HOME_REFERENCE_STATE = 0x10230B5,
    EPOS_OD_CURRENT_DEMAND_VALUE = 0x40030D0,
     ...
     EPOS_OD_HOLDING_BRAKE_PARAMETERS_HOLDING_BRAKE_STATE = 0x1033158,
     ...
     EPOS_OD_ANALOG_INPUT_GENERAL_PURPOSE_ANALOG_INPUT_GENERAL_PURPOSE_A = 0x2013162,
     EPOS_OD_ANALOG_INPUT_GENERAL_PURPOSE_ANALOG_INPUT_GENERAL_PURPOSE_B = 0x2023162,
     ...
     EPOS_OD_ANALOG_INPUT_CURRENT_SET_VALUE_PROPERTIES_CURRENT_SET_VALUE_FIRST_VOLTAGE = 0x4013170,
     EPOS_OD_ANALOG_INPUT_CURRENT_SET_VALUE_PROPERTIES_CURRENT_SET_VALUE_FIRST_CURRENT = 0x4023170,
     EPOS_OD_ANALOG_INPUT_CURRENT_SET_VALUE_PROPERTIES_CURRENT_SET_VALUE_SECOND_VOLTAGE = 0x4033170,
     EPOS_OD_ANALOG_INPUT_CURRENT_SET_VALUE_PROPERTIES_CURRENT_SET_VALUE_SECOND_CURRENT = 0x4043170,
     EPOS_OD_ANALOG_INPUT_VELOCITY_SET_VALUE_PROPERTIES_VELOCITY_SET_VALUE_FIRST_VOLTAGE = 0x4013171,
     EPOS_OD_ANALOG_INPUT_VELOCITY_SET_VALUE_PROPERTIES_VELOCITY_SET_VALUE_FIRST_VELOCITY = 0x4023171,
     EPOS_OD_ANALOG_INPUT_VELOCITY_SET_VALUE_PROPERTIES_VELOCITY_SET_VALUE_SECOND_VOLTAGE = 0x4033171,
     EPOS_OD_ANALOG_INPUT_VELOCITY_SET_VALUE_PROPERTIES_VELOCITY_SET_VALUE_SECOND_VELOCITY = 0x4043171,
     ...
     EPOS_OD_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_1 = 0x40131E0,
     EPOS_OD_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_2 = 0x40231E0,
     EPOS_OD_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_3 = 0x40331E0,
     EPOS_OD_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_INTERNAL_DATA_RECORDER_VARIABLE_INDEX_4 = 0x40431E0,
     EPOS_OD_INTERNAL_DATA_RECORDER_CONFIGURATION_INTERNAL_DATA_RECORDER_SAMPLING_PERIOD = 0x20131E1,
     EPOS_OD_INTERNAL_DATA_RECORDER_CONFIGURATION_INTERNAL_DATA_RECORDER_MAX_NUMBER_OF_SAMPLES = 0x20231E1,
     EPOS_OD_INTERNAL_DATA_RECORDER_TRIGGER_INTERNAL_DATA_RECORDER_TRIGGER_VARIABLE_INDEX = 0x40131E2,
     EPOS_OD_INTERNAL_DATA_RECORDER_TRIGGER_INTERNAL_DATA_RECORDER_TRIGGER_MODE = 0x10231E2,
     EPOS_OD_INTERNAL_DATA_RECORDER_TRIGGER_INTERNAL_DATA_RECORDER_TRIGGER_HIGH_VALUE = 0x40331E2,
     EPOS_OD_INTERNAL_DATA_RECORDER_TRIGGER_INTERNAL_DATA_RECORDER_TRIGGER_LOW_VALUE = 0x40431E2,
     EPOS_OD_INTERNAL_DATA_RECORDER_TRIGGER_INTERNAL_DATA_RECORDER_TRIGGER_MASK = 0x40531E2,
     EPOS_OD_INTERNAL_DATA_RECORDER_TRIGGER_INTERNAL_DATA_RECORDER_TRIGGER_NUMBER_OF_PRECEDING_SAMPLES = 0x20631E2,
     EPOS_OD_INTERNAL_DATA_RECORDER_CONTROL_INTERNAL_DATA_RECORDER_CONTROLWORD = 0x20131E4,
     EPOS_OD_INTERNAL_DATA_RECORDER_CONTROL_INTERNAL_DATA_RECORDER_STATUSWORD = 0x20231E4,
     EPOS_OD_INTERNAL_DATA_RECORDER_DATA_INTERNAL_DATA_RECORDER_NUMBER_OF_RECORDED_SAMPLES = 0x20131E5,
     EPOS_OD_INTERNAL_DATA_RECORDER_DATA_INTERNAL_RECORDER_BUFFER_TIMESTAMP = 0x40231E5,
     EPOS_OD_POWER_LIMITATION_I2T_LEVEL_MOTOR = 0x2013200,
     EPOS_OD_POWER_LIMITATION_I2T_LEVEL_POWER_STAGE = 0x2023200,
     EPOS_OD_THERMAL_OVERLOAD_PROTECTION_TEMPERATURE_POWER_STAGE = 0x2013201,
     EPOS_OD_THERMAL_OVERLOAD_PROTECTION_MAXIMAL_TEMPERATURE_POWER_STAGE = 0x2043201,
     EPOS_OD_INTERNAL_TEST_OBJECT_INTERNAL_SPI_EXTENSION_TEST = 0x4013240,
     EPOS_OD_INTERNAL_TEST_OBJECT_INTERNAL_ADC_ENCODER_2_CHANNEL_A_ANALOG_VALUE = 0x2023240,
     EPOS_OD_INTERNAL_TEST_OBJECT_INTERNAL_ADC_ENCODER_2_CHANNEL_B_ANALOG_VALUE = 0x2033240,
     EPOS_OD_INTERNAL_MOTOR_CONTROL_INTERNAL_ADC_CURRENT_OFFSET_SIMULTANEOUS_PHASE_U = 0x2013241,
     EPOS_OD_INTERNAL_MOTOR_CONTROL_INTERNAL_ADC_CURRENT_OFFSET_SIMULTANEOUS_PHASE_V = 0x2023241,
     EPOS_OD_INTERNAL_MOTOR_CONTROL_INTERNAL_ADC_CURRENT_OFFSET_SEQUENTIAL_PHASE_U = 0x2033241,
     EPOS_OD_INTERNAL_MOTOR_CONTROL_INTERNAL_ADC_CURRENT_OFFSET_SEQUENTIAL_PHASE_V = 0x2043241,
     EPOS_OD_INTERNAL_MOTOR_CONTROL_INTERNAL_ADC_CURRENT_OFFSET_SEQUENTIAL_PHASE_W = 0x2053241,
     EPOS_OD_INTERNAL_MOTOR_CONTROL_INTERNAL_ELECTRICAL_ROTOR_ANGLE = 0x4063241,
     EPOS_OD_INTERNAL_CONFIGURATION_ELECTRICAL_SYSTEM_TUNING_INTERNAL_LR_IDENTIFICATION_CURRENT = 0x2013248,
     EPOS_OD_INTERNAL_CONFIGURATION_ELECTRICAL_SYSTEM_TUNING_INTERNAL_LR_IDENTIFICATION_FREQUENCY = 0x2023248,
     EPOS_OD_INTERNAL_PARAMETERS_ELECTRICAL_SYSTEM_TUNING_INTERNAL_RESISTANCE = 0x4013249,
     EPOS_OD_INTERNAL_PARAMETERS_ELECTRICAL_SYSTEM_TUNING_INTERNAL_INDUCTANCE = 0x2023249,
     EPOS_OD_INTERNAL_PARAMETERS_ELECTRICAL_SYSTEM_TUNING_INTERNAL_FREQUENCY = 0x2033249,
     EPOS_OD_INTERNAL_CONFIGURATION_MECHANICAL_SYSTEM_TUNING_INTERNAL_CUT_OFF_FREQUENCY_OF_OSCILLATION = 0x401324B,
     EPOS_OD_INTERNAL_CONFIGURATION_MECHANICAL_SYSTEM_TUNING_INTERNAL_TARGET_AMPLITUDE_OF_OSCILLATION = 0x402324B,
     EPOS_OD_INTERNAL_CONFIGURATION_MECHANICAL_SYSTEM_TUNING_INTERNAL_IDENTIFY_KM = 0x103324B,
     EPOS_OD_INTERNAL_CONFIGURATION_MECHANICAL_SYSTEM_TUNING_INTERNAL_PROPORTIONAL_GAIN_FOR_DYNAMIC_FRICTION = 0x404324B,       
     EPOS_OD_INTERNAL_CONFIGURATION_MECHANICAL_SYSTEM_TUNING_INTERNAL_INTEGRAL_GAIN_FOR_DYNAMIC_FRICTION = 0x405324B,
     EPOS_OD_INTERNAL_PARAMETERS_MECHANICAL_SYSTEM_TUNING_INTERNAL_CYCLE_DURATION = 0x401324C,
     EPOS_OD_INTERNAL_PARAMETERS_MECHANICAL_SYSTEM_TUNING_INTERNAL_SET_VALUE_OF_CURRENT = 0x202324C,
     EPOS_OD_INTERNAL_PARAMETERS_MECHANICAL_SYSTEM_TUNING_INTERNAL_ACTUAL_POSITION_PEAK_VALUE = 0x403324C,
     EPOS_OD_INTERNAL_PARAMETERS_MECHANICAL_SYSTEM_TUNING_INTERNAL_ACTUAL_VALUE_OF_DYNAMIC_FRICTION = 0x404324C,
     EPOS_OD_INTERNAL_PARAMETERS_MECHANICAL_SYSTEM_TUNING_INTERNAL_EXTRA_DELAY = 0x406324C,
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_CONFIGURATION_INTERNAL_PRBS_VELOCITY_TUNING_STEP_AMPLITUDE = 0x401324D,
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_CONFIGURATION_INTERNAL_PRBS_VELOCITY_TUNING_CYCLE_TIME = 0x402324D,
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_CONFIGURATION_INTERNAL_PRBS_VELOCITY_TUNING_TARGET_AMPLITUDE = 0x203324D,
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_CONFIGURATION_INTERNAL_PRBS_VELOCITY_TUNING_MAX_CYCLE_TIME_FACTOR = 0x204324D,       
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_PARAMETER_INTERNAL_PRBS_VELOCITY_TUNING_EXCITATION_AMPLITUDE = 0x401324E,
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_EXCITATION_OFFSET_INTERNAL_PRBS_VELOCITY_TUNING_EXCITATION_OFFSET_1 = 0x4013250,     
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_EXCITATION_OFFSET_INTERNAL_PRBS_VELOCITY_TUNING_EXCITATION_OFFSET_2 = 0x4023250,     
     EPOS_OD_INTERNAL_PRBS_VELOCITY_TUNING_EXCITATION_OFFSET_INTERNAL_PRBS_VELOCITY_TUNING_EXCITATION_OFFSET_3 = 0x4033250,
